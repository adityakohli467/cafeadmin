...
class Auth extends CI_Controller {
    ...
    function index() {
        ...
        if (!$this->ion_auth->logged_in()) {
            ...
            // for showing the landing page to choose where user wants to login
          redirect('auth/login');
            // redirect('auth/login');
...
function login2(){
     $this->data['title'] = "Login";
        ...
        if ($this->form_validation->run() == true) {
            ...
            if ($this->ion_auth->login($this->input->post('email'), $this->input->post('password'), $remember)) {
                ...
                redirect('auth/login2', 'refresh'); //use redirects instead of loading views for compatibility with MY_Controller libraries
            }
        } else {
    ...
    //log the user in
    function login($not_redirect='') {
     
        // if($not_redirect == ''){
             redirect('general/home_redirect');
        // }
        ...
        if ($this->form_validation->run() == false) {
           ...
           // $this->load->view('footer');
            ...
            if ($forgotten) {
                ...
                $this->session->set_flashdata('message', $this->ion_auth->messages());
                redirect("auth/login2", 'refresh'); //we should display a confirmation page here instead of the login page
            } else {
                $this->session->set_flashdata('message', $this->ion_auth->errors());
