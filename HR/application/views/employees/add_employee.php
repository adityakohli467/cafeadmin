<div class="row item">
		...
		<form class="form-horizontal" id="employee_add" role="form" method="post" action="<?php echo base_url(); ?>index.php/admin/submit_employee" enctype="multipart/form-data">
...
<div class="container-fluid main-container">
	...
	<span>
			        ...
			        <div class="panel-heading">
	          		...
	          		<div class="panel-body">
						<div class="form-group">
							<label for="businessname" class="col-lg-4 col-sm-12 control-label">First Name:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
								<input type="text" class="form-control" name="first_name" autocomplete="off" >
							</div>
						</div>
						<div class="form-group">
							<label for="businessname" class="col-lg-4 col-sm-12 control-label">Last Name:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
								<input type="text" class="form-control" name="last_name" autocomplete="off" >
							</div>
						</div>
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">Email:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
						...
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">Pin:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
								<input type="password" class="form-control" name="pin"  autocomplete="off">
							</div>
						</div>
						
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">Hourly Rate:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
						...
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">Department:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
						...
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">Job Description:</label>
							<div class="col-lg-8 col-sm-12">
			...
			<button type="submit" name="contact_submit"  class="btn btn-success btn-ph">Add New Employee</button>
