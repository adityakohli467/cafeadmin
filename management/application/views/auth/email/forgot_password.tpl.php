...
<br><br>
<a href="<?php echo base_url(); ?>index.php/orders/viewSupplierOrder/<?php echo $order_id;?>" class="btn btn-success" target="_blank">	<h1><?php echo sprintf(lang('email_forgot_password_heading'), $identity);?></h1>
	<p><?php echo sprintf(lang('email_forgot_password_subheading'), anchor('auth/reset_password/'. $forgotten_password_code, lang('email_forgot_password_link')));?></p></a>