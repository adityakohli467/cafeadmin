 <form class="form-horizontal"  role="form" method="post" action="<?php echo base_url(); ?>index.php/forms/update_review_form" enctype="multipart/form-data">
        	...
        	<div class="col-md-6">
	        	<div class="panel pn">
	        		<div class="gradient"></div>
	          		...
	          		<div class="panel-body">
	          		    ...
	          		    ?>
							...
							<input type="<?php echo $field['type']; ?>" <?php echo $disabled; ?> class="form-control" name="<?php echo $field['name']; ?>" value="<?php if(isset($field['value'])){ echo $field['value']; } ?>"  <?php if($field['required'] == '1'){ echo 'required'; } ?> >
							</div>
						</div>
						<?php } } ?>
				 ...
				 <div class="btn-div col-lg-12 col-sm-12">
			         ...
			         <button type="submit" name="formSubmit" id="form_submit" class="btn btn-success btn-ph">UPDATE</button>
			         <?php } ?>
