...
function SubmitFormData() {
    ...
    if(error != 'True' && error2 != 'True'){
    	...
    	$.post("<?php echo base_url(); ?>index.php/reports/budget_orders_submit", { time_period: time_period,start_date: start_date, end_date: end_date, supplier: supplier, category: category },
		    function(data) {
		    	//alert(data);
				 $('#results').html(data);
				 $('.datatable').DataTable( {
