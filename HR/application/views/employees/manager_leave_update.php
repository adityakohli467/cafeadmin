			...
			<?php foreach($leaves as $row){ ?>
	        	<div class="panel pn">
			        ...
			        <div class="panel-heading">
			        	<h3 class="panel-title"><b>LEAVE INFO</b></h3>
			        </div>
	          		<div class="panel-body">
	          		    
	          		    <div class="form-group">
							<label for="businessname" class="col-sm-4 control-label">Employee Name:<span>*</span></label>
							<div class="col-sm-8">
							<input type="text" readonly name="empname" value="<?php echo $emp_name; ?>">
							</div>
						</div>
						 ...
						 <div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" readonly name="sdate" value="<?php echo date("d-m-Y",strtotime($row->start_date)); ?>">
							</div>
						</div>
						
						 <div class="form-group">
							<label for="businessname" class="col-sm-4 control-label">End Date:<span>*</span></label>
							<div class="col-sm-8">
								<input type="text" readonly name="edate" value="<?php echo date("d-m-Y",strtotime($row->end_date)); ?>">
							</div>
						</div>
						<div class="form-group">
							<label for="" class="col-sm-4 control-label">Nominated person:<span>*</span></label>
							<div class="col-sm-8">
						...
						<?php if($row->comments != ''){ ?>
						<div class="form-group">
							<label for="businessname" class="col-sm-4 control-label">Add Comments:<span>*</span></label>
							<div class="col-sm-8">
...
<script type="text/javascript">
	$(document).ready(function() { 
	    $("#employee_add").validate({
			...
			messages: {
			leave_status: {
	                required:"Please update the Leave Status"
	            }   
			}
