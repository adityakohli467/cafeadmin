	...
	<form action="<?php echo base_url(); ?>index.php/menuplanner/saveWeekMenu" method="POST">
	<div style="margin-bottom:0px;" class="col-md-12 page-head border-bottom">
			<span class="text-center">
				<h3>Menu Planner Creation</h3>
			</span>
			
			<button type="submit" class="btn btn-success btn-ph">Recreate Menu</button>
...
<div style="background-color:#fff;" class="container-fluid main-container ct-mngemp">
	<div class="col-md-12">
		<div style="box-shadow:none;" class="panel panel-default cah-border">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $monMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        ...
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $monMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $monMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $tueMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $tueMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $tueMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $tueMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $tueMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $tueMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $wedMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $wedMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $wedMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $wedMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $wedMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $wedMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $thuMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $thuMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $thuMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $thuMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $thuMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $thuMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $friMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $friMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $friMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $friMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $friMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $friMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $satMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $satMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $satMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $satMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $satMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $satMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
                                                                    ...
                                                                    <tr class="menurow">
                                                                        <td class="menutbth-width">
                                                                             <select class="form-control selectmenu" onchange="fetchMenus(this);">
                                                                                <option value=''>Select Category</option>
                                                                                	<?php foreach($menuCategory as $row){  	
                                                                                	if($row->category_id == $sunMenu[0]->menu_category_id){ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>" selected><?php echo $row->name; ?></option>
                                                                                	<?php } else{ ?>
                                                                                	    <option value="<?php echo $row->category_id ?>"><?php echo $row->name; ?></option>
                                                                                	<?php } } ?>
                                                                        ...
                                                                        <td class="menuinput-width"> <span class="label_text">Category</span>
                                                                            <input class="form-control category" type="text" name="category" value="<?php echo $sunMenu[0]->subcategory_name ?>" readonly placeholder="Category">
                                                                        </td>
                                                                        <td class="menuinput-width">   <span class="label_text">Regular</span>
                                                                            <input class="form-control regular" type="text" name="regular" value="<?php echo $sunMenu[0]->regular ?>" readonly placeholder="Regular">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Regular Color</span>
                                                                            <input class="form-control regular_color" type="text" name="regular_color" value="<?php echo $sunMenu[0]->regular_color ?>" readonly placeholder="Regular Color">
                                                                        </td>
                                                                        <td class="menuinput-width">  <span class="label_text">Large</span>
                                                                            <input class="form-control large" type="text" name="large" value="<?php echo $sunMenu[0]->large ?>" readonly placeholder="Large">
                                                                        </td>
                                                                        <td class="menuinput-width"> <span class="label_text">Large Color</span>
                                                                            <input class="form-control large_color" type="text" name="large_color" value="<?php echo $sunMenu[0]->large_color ?>" readonly placeholder="Large Color">
                                                                        </td>
                                                                        <td class="menubtns-width">
                                                                            <div class="ct-btns">
                                                                                    <?php if($i == '1'){ ?>
        ...
        if(menuPlannerID == ''){
		    ...
		    success: function(data){
                 ...
                 $.each(data1, function(i, value) {
                     ...
                     var selectInputcategory=$(obj).closest(".menurow").find(".category"); 
                     selectInputcategory.val(value.subcategory_name);
