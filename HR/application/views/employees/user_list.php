...
.dataTables_filter label {
	...
	<div style="margin-bottom:0px;" class="col-md-12 page-head border-bottom">
		<span class="text-center">
			...
			<a href="<?php echo base_url(); ?>index.php/admin/create_user">
			<button type="button" class="btn btn-success btn-ph">Add User</button></a>
	...
	<div class="col-md-12">
		<div style="box-shadow:none;" class="panel panel-default">
			...
			<table id="example" class="row-border table-condensed datatable" cellspacing="0" width="100%">
				...
				?>
					<tr class="tr">
						<td class="text-left"><a href="<?php echo base_url(); ?>index.php/admin/create_user/<?php echo $row->customer_user_id; ?>"><?php echo $row->username; ?></a></td>
						
						<td class="text-left"><?php echo $row->email; ?></td>
						<td class="text-center"><?php echo $row->phone; ?></td>
					    
						<th class="text-center"><a><type="button" onClick="delete_row(<?php echo  $row->customer_user_id ?>);"><span class="glyphicon glyphicon-remove"></span></a></th>
					</tr>
				<?php } ?>
				</tbody>
			</table>
...
<script type="text/javascript">
	function delete_row(str){
		if(confirm('Are you sure you want to delete the Users details')){
		    $.ajax({
				type: "POST",
