...
if(!empty($employee_weekly_timesheet_details)){
  ...
  <!-- Add Coment Modal HTML -->
   ...
   function DownloadButtonFUn(){
        window.location.href = "https://www.cafeadmin.com.au/HR/index.php/Employeedetails/download_textfile/<?php echo $timesheet_id; ?>/<?php echo $roster_group_id; ?>/casual";
   }
   function DownloadButtonFUn2(){
        window.location.href = "https://www.cafeadmin.com.au/HR/index.php/Employeedetails/download_textfile/<?php echo $timesheet_id; ?>/<?php echo $roster_group_id; ?>";
   }
