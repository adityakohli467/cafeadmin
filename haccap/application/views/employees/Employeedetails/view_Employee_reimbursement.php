<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/table_design.css">
	<div class="container">
        <div class="table-wrapper">
            <div class="table-title">
				...
				<div style="margin-bottom:0px;" class="col-md-12 page-head">
                  <span class="text-center">
						...
						<a class="btn btn-success btn-ph" href="<?php echo base_url(); ?>index.php/Employeedetails/Employee_reimbursement">
            ...
            <?php if($role =='employee'){ ?>               
                       <a href="<?php echo base_url(); ?>index.php/Employeedetails/edit_Employee_reimbursement/<?php echo $row->Employee_reimbursement_id ?>/view">
                           <i class="material-icons" data-toggle="tooltip" title="View">&#xe417;</i></a>
                           <?php }else{  ?>
                              <a href="<?php echo base_url(); ?>index.php/Employeedetails/edit_Employee_reimbursement/<?php echo $row->Employee_reimbursement_id ?>/edit">
