...
//   alert("<?php echo base_url('index.php/Employeedetails/download_FortnightTextfile/'); ?>"+TImeIDS+"/"+RGIDS)
 window.location.href = "<?php echo base_url('index.php/Employeedetails/download_FortnightTextfile'); ?>?TimehseetIds="+TImeIDS+"&RGId="+RGIDS;
...
function downloadTotalHours(){
    ...
    var TImeIDS = TimehseetId.join();
     var RGIDS = RosterGroupId.join();
//   alert("<?php echo base_url('index.php/Employeedetails/download_FortnightTextfile/'); ?>"+TImeIDS+"/"+RGIDS)
 window.location.href = "<?php echo base_url('index.php/Employeedetails/download_total_hours'); ?>?TimehseetIds="+TImeIDS+"&RGId="+RGIDS;
