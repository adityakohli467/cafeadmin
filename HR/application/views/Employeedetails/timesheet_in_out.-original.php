...
<table border="1" class="ct-timeset">
	...
	<?php if(!empty($all_emps)){ ?>
       ...
       <input type="hidden" class="roster_id" value="<?php echo $all_emp->roster_id; ?>">     
        ...
        <td data-toggle="modal" data-target="#pinModal" class="monday_in_pintime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
            <?php } ?>
         ...
         <?php if(isset($all_emp->break_in_time) && $all_emp->break_in_time !='00:00:00'){ ?>  
           ...
           <td  style="display:none"  class="monday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="monday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="monday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
         ...
         <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="monday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
  ...
  <table>	
        <thead>	<tr class="ct-in-header"><th>IN</th><th>Break In</th> <th>Break Out</th><th>OUT</th>	</tr></thead><tbody>	<tr>
            ...
            <td data-toggle="modal" data-target="#pinModal" class="tuesday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
            <?php } ?>
           ...
           <td  style="display:none"  class="tuesday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="tuesday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="tuesday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
           ...
           <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="tuesday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
             <?php } ?>
  ...
  <table>	
        <thead>	<tr class="ct-in-header"><th>IN</th><th>Break In</th> <th>Break Out</th><th>OUT</th>	</tr></thead><tbody>	<tr>
            ...
            <td data-toggle="modal" data-target="#pinModal" class="wednesday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
               <?php } ?>
           ...
           <td  style="display:none"  class="wednesday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="wednesday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="wednesday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
           ...
           <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="wednesday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
            <?php } ?>
      ...
      <?php if(date("l") =='Thursday') { ?>        
        ...
        <thead>	<tr class="ct-in-header"><th>IN</th><th>Break In</th><th>Break Out</th>	<th>OUT</th></tr></thead><tbody>	<tr>
            ...
            <td data-toggle="modal" data-target="#pinModal" class="thursday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
            <?php } ?>
           ...
           <td  style="display:none"  class="thursday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="thursday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="thursday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
           ...
           <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="thursday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
             <?php } ?>
        ...
        <thead>	<tr class="ct-in-header"><th>IN</th><th>Break In</th> <th>Break Out</th><th>OUT</th>	</tr></thead><tbody>	<tr>
            ...
            <td data-toggle="modal" data-target="#pinModal" class="friday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
            <?php } ?>
           ...
           <td  style="display:none"  class="friday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="friday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="friday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
           ...
           <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="friday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
             <?php } ?>
        ...
        <thead>	<tr class="ct-in-header"><th>IN</th><th>Break In</th> <th>Break Out</th><th>OUT</th>	</tr></thead><tbody>	<tr>
            ...
            <td data-toggle="modal" data-target="#pinModal" class="saturday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
             <?php } ?>
           ...
           <td  style="display:none"  class="saturday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="saturday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="saturday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
            ...
            <td class="saturday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
             <?php } ?>
        ...
        <td data-toggle="modal" data-target="#pinModal" class="sunday_in_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
             <?php } ?>
           ...
           <td  style="display:none"  class="sunday_breaktime<?php echo $all_emp->emp_id; ?><?php echo $all_emp->roster_id; ?>" data-toggle="modal" data-target="#break_time" onclick="show_modal('break_time',<?php echo $all_emp->emp_id; ?>,this,<?php echo $all_emp->roster_id; ?>)"><i class="material-icons"></i></td>				            
            <td class="sunday_break_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
        <?php } ?>
         ...
         <?php if(isset($all_emp->break_out_time) && $all_emp->break_out_time !='00:00:00'){ ?>   
           ...
           <?php }else{ ?>
            ...
            <td class="sunday_break_pinouttime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>	
         <?php } ?>
         ...
         <?php if(isset($all_emp->out_time) && $all_emp->out_time !='00:00:00'){ ?>
            ...
            <td class="sunday_out_pintime<?php echo $all_emp->emp_id?><?php echo $all_emp->roster_id; ?>"data-toggle="modal"  data-target="#pinModal" onclick="show_pin_modal(<?php echo $all_emp->emp_id; ?>,this)">ENTER PIN</td>		
              <?php } ?>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p style="border: 2px solid #37b53c;"><input type="password" id="employee_pin_entered" name="employee_pin" autocomplete="new-password"><input type="hidden" id="pin_emp_id">
