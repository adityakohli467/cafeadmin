                    ...
                    <div class="card-header border-bottom-dashed">
                        ...
                        <div class="row g-4 align-items-center">
                            ...
                            <div class="col-sm-auto">
                                <div>
                                    <a class="btn btn-success add-btn" href="<?php echo base_url(); ?>index.php/reports/add_record/<?php echo $table_name; ?>"><i class="ri-add-line align-bottom me-1"></i> Add New</a>
                                ...
                                <table class="table align-middle" id="customerTable">
                                    <thead class="table-dark text-white">
                                        <tr>
                                            ...
                                            <?php } } ?>
                                            <?php if(!empty($action_columns) && in_array('recreate',$action_columns)){ ?>
                                            <th width="120" class="text-center">Re-create</th>
                                            <?php } ?>
                                    ...
                                    <tbody class="list form-check-all" id="formRow">
                                        ...
                                        <tr>
                                            ...
                                            <?php } } ?>
                                            <?php $id=$table_name.'_id'; if(!empty($action_columns) && in_array('recreate',$action_columns)){ ?>
                                                <td class="<?php echo $table_col; ?> text-center"><a class="btn btn-success add-btn" href="<?php echo base_url(); ?>index.php/reports/recreate_record/<?php echo $table_name.'/'.$row[$id]; ?>"></i> Re-create</a></td>
                                            <?php } ?>
                                            <td>
                                                <ul class="list-inline hstack gap-2 mb-0">
                                                   <?php if(!empty($action_columns) && in_array('view',$action_columns)){ ?>
                                                    <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="View">
                                                        <a class="text-success d-inline-block edit-item-btn" href="<?php echo base_url(); ?>index.php/reports/view_record/<?php echo $table_name.'/'.$row[$id]; ?>">
                                                    ...
                                                    <li class="list-inline-item" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Edit">
                                                        <a class="text-success d-inline-block edit-item-btn" href="<?php echo base_url(); ?>index.php/reports/edit_record/<?php echo $table_name.'/'.$row[$id]; ?>">
...
$('.remove-item-btn').click(function(){
  ...
  $("#filterBtn").click(function(e){
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo base_url(); ?>index.php/reports/filterData/"+table_name,
        data: data1,
        success: function(data){
            if(data != 'norecord'){
                $("#formRow").html('');
