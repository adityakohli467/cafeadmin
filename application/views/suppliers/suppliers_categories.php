        ...
        <div style="margin-bottom:0px;" class="col-md-12 page-head border-bottom">
			...
			<div class="btn-div col-md-3">
				<button type="button" class="btn btn-success btn-ph" id="myBtn">Add Supplier Category</button>
			</div>
		</div><!--.col-md-12 -->
		<!-- Modal -->
	  ...
	  <div class="modal fade" id="myModal" role="dialog">
	    <div class="modal-dialog">
	     ...
	     <form role="form" class="form-horizontal" id="contact_form" method="post" action="<?php echo base_url().'index.php/suppliers/add_supp_cat'; ?>">
		...
		<div style="box-shadow:none;" class="panel panel-default">
          ...
          <?php } ?>
				<table id="example" class="row-border table-condensed datatable" cellspacing="0" width="100%">
					...
					<tbody>
						<?php foreach($sup_category as $row){ ?>
						<tr class="tr">
	...
	<div class="modal fade" id="updateModal" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				<form role="form" class="form-horizontal" id="contact_form_edit" method="post" action="<?php echo base_url().'index.php/suppliers/update_supplier_category'; ?>">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
...
if(confirm('Are you sure you want to delete category')){
		    ...
		    $.ajax({
		type: "POST",
        url: "<?php echo base_url();?>index.php/suppliers/category_delete",
        data:'id='+str,
...
<script>
	function edit_row(str){
		    ...
		    $.ajax({
		type: "POST",
        url: "<?php echo base_url();?>index.php/suppliers/edit_supp_cat",
        data:'id='+str,
        success: function(data){
        	//alert(data);
