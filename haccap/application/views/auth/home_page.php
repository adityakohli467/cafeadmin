...
<body>
    ...
    <div class="auth-page-wrapper bg-soft-dark py-5 d-flex justify-content-center align-items-center min-vh-100" >
        ...
        <div class="auth-page-content overflow-hidden pt-lg-5">
            <h1 class="text-white mb-3 text-center">HACCP MANAGEMENT</h1>
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="col-lg-6 p-5 bg-secondary">
                                    <div class="p-lg-5 p-4 h-100">
                                        ...
                                        <div class="p-lg-4 mt-4 mb-4 text-center ">
                                            <div class="mb-4">
                                                <h5 class=" text-dark"><strong>Login to Staff portal!</strong></h5>
                                            </div>
                                            <!-- Buttons with Label -->
                                            <a href="<?php echo base_url(""); ?>index.php/auth/login/manager"><button type="button" class="btn btn-lg btn-dark btn-label waves-effect waves-light"><i class="ri-user-line label-icon align-middle fs-16 me-2"></i> Login</button></a>
                                        </div>
