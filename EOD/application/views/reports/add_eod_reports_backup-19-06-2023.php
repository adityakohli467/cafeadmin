        ...
        <div class="col-lg-12">
            <div class="page-content-inner">
                <div class="card" id="userList">
                    ...
                    <form enctype='multiaart/form-data' action="<?php echo base_url() ?>index.php/reports/submit_<?php echo $table_name;?>" method="post" class="form-horizontal" >    
                                                    ...
                                                    <div class="col-sm">
                                                        <div class="row">
                                                            <div class="col-12 col-lg-2 col-md-3 mb-3">
                                                                ...
                                                                <input type="text" <?php echo $disabled; ?> class="form-control" id="eod_name" name="eod_name" value="<?php echo $record['eod_name']; ?>" placeholder="eod name" required>
                                                            </div>
                                                                                                            
                                                        
                                                            <div class="col-12 col-lg-2 col-md-3 mb-3">
                                                                <label>eod date </label>
                                                                <input type="date" <?php echo $disabled; ?> class="form-control" id="eod_date" name="eod_date" value="<?php echo $record['eod_date']; ?>" placeholder="eod date" required>
                                                            </div>
                                                        </div>
                                                    </div>
                                                             ...
                                                             <table class="row-border table-condensed supplierCostTable" cellspacing="0" width="100%">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    foreach($record['content'] as $row ){ ?>
                                                                        ...
                                                                        <tr class="menurow">
                                                                            ...
                                                                            <td class="menuinput-width">
                                                                                <div class="form-icon">
                                                                                    <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon cash_read_input" id="cash_read" name="cash_read[]" <?php if($form_type != 'recreate'){ ?>value="<?php echo round($row['cash_read'], 2); ?>"<?php } ?> >
                                                                                    <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                                 <div class="form-icon">
                                                                                    <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon cc_read_input" id="cc_read" name="cc_read[]" <?php if($form_type != 'recreate'){ ?>value="<?php echo $row['cc_read']; ?>"<?php } ?> >
                                                                                    <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow">
                                                                            ...
                                                                            <td class="menuinput-width">
                                                                                 <div class="form-icon">
                                                                                    <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon cash_read_input" id="cash_read" name="cash_read[]" >
                                                                                    <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                                 <div class="form-icon">
                                                                                    <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon cc_read_input" id="cc_read" name="cc_read[]" >
                                                                                    <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="menurow">
                                                                            ...
                                                                            <td class="menuinput-width">
                                                                                <div class="form-icon">
                                                                                <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="main_cafe_cash_read_total" name="main_cafe_cash_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['main_cafe_cash_read_total']; ?>" <?php } ?>>
                                                                                <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                                <div class="form-icon">
                                                                                <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="main_cafe_cc_read_total" name="main_cafe_cc_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['main_cafe_cc_read_total']; ?>" <?php } ?>>
                                                                                <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow catering_hide">
                                                                            ...
                                                                            <td class="menuinput-width">
                                                                                <div class="form-icon">
                                                                                <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="catering_cash_read_total" name="catering_cash_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['catering_cash_read_total']; ?>" <?php } ?>>
                                                                                <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                                <div class="form-icon">
                                                                                <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="catering_cc_read_total" name="catering_cc_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['catering_cc_read_total']; ?>" <?php } ?>>
                                                                                <i class="bx bx-dollar"></i>
                                                                                </div>
                                                                            </td>
                                                                            <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow">
                                                                        ...
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="cafeonline_cash_read_total" name="cafeonline_cash_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['cafeonline_cash_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="cafeonline_cc_read_total" name="cafeonline_cc_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['cafeonline_cc_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow catering_hide">
                                                                        ...
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="Hc_cash_read_total" name="Hc_cash_read_total"  <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['Hc_cash_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="Hc_cc_read_total" name="Hc_cc_read_total"  <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['Hc_cc_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div> 
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow">
                                                                        ...
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="Other_specify_cash_read_total" name="Other_specify_cash_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['Other_specify_cash_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="Other_specify_cc_read_total" name="Other_specify_cc_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['Other_specify_cc_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                    ...
                                                                    <tr class="menurow">
                                                                        ...
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="total_cash_read_total" name="total_cash_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['total_cash_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                            <div class="form-icon">
                                                                            <input type="number" step="any" <?php echo $disabled; ?> class="form-control form-control-icon" id="total_cc_read_total" name="total_cc_read_total" <?php if($form_type != 'recreate'){ ?> value="<?php echo $record['content_total_cash']['total_cc_read_total']; ?>" <?php } ?>>
                                                                            <i class="bx bx-dollar"></i>
                                                                            </div>
                                                                        </td>
                                                                        <td class="menuinput-width">
                                                                                ...
                                                                                <td class="menuinput-width" colspan="3">
                                                                                   <table style="max-width:100%;width:100%;">
                                                                                        ...
                                                                                        <tbody class="dataWrap">
                                                                                           <tr><th><div class="customTableCell"><input type="text"  <?php echo $disabled; ?> class="form-control" id="invoice_paid_cash" name="invoice_paid_cash[]" <?php if($form_type != 'recreate'){ ?> value="<?php echo $row['invoice_paid_cash']; ?>" <?php } ?>  ></div></th>
                                                                                           <th><div class="customTableCell"><div class="form-icon"><input type="number" step="any" <?php echo $disabled; ?> class="form-control category_cost form-control-icon" onkeyup="addCost(this)" id="total_inc_gst" name="total_inc_gst[]" <?php if($form_type != 'recreate'){ ?> value="<?php echo $row['total_inc_gst']; ?>" <?php } ?>  ><i class="bx bx-dollar"></i></div></div></th>
                                                                                            <?php if($form_type == 'view' ){ ?>
                                                                                            <th><div class="customTableCell"><a href="<?php echo base_url();?>uploaded_files_inv_paid/<?php echo $row['uploaded_file_name']; ?>" target="_blank">View file</a></div></th>
                                                                                            <?php }else { ?>
                                                                                      <th><div class="customTableCell"><input type="file" class="form-control" id="invoice_doc" name="invoice_doc[]" multiple="multiple"></div></th>
                                                                        ...
                                                                        <tr class="menurow">
                                                                            <td class="menuinput-width" colspan="3">
                                                                               <table style="max-width:100%;width:100%;">
                                                                                    ...
                                                                                    <tbody class="dataWrap">
                                                                                       <tr><th><div class="customTableCell"><input type="text" <?php echo $disabled; ?> class="form-control" id="invoice_paid_cash" name="invoice_paid_cash[]"></div></th>
                                                                                       <th><div class="customTableCell"><div class="form-icon"><input type="number" step="any" <?php echo $disabled; ?> class="form-control category_cost form-control-icon" onkeyup="addCost(this)" id="total_inc_gst" name="total_inc_gst[]" value="0"><i class="bx bx-dollar"></i></div></div></th>
                                                                                       <th><div class="customTableCell"><input type="file" class="form-control" id="invoice_doc" name="invoice_doc[]" multiple="multiple"></div></th>
                                                                                       </tr>
                                                                                    </tbody>
                                                                                </table>
...
function calculate_total_cost(){
    ...
    $('.mainCafeCheckbox').each(function() {
        ...
        totalIncome = (parseFloat(totalMainCafeCashRead1)+parseFloat(totalMainCafeCCRead1)+parseFloat(totalMainCafeOver1)+parseFloat(totalMainCafeCCOver1)+parseFloat(totalMainCafesmartCards1))-parseFloat(totalMainCafegstRead1);
...
function calculate_total(){
    ...
    $('.till_name').each(function() {
        ...
        if($(this).val() != ''){
            ...
            // Efptos calculate
            var amexCostValue = $(this).closest('.menurow').find('.amexCost').val();
            var crdrCostValue = $(this).closest('.menurow').find('.crdrCost').val();
