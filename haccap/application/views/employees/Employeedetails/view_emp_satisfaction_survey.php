            ...
            <div class="table-title">
				...
				<div style="margin-bottom:0px;" class="col-md-12 page-head">
                  <span class="text-center">
						...
						<a class="btn btn-success btn-ph" href="<?php echo base_url(); ?>index.php/Employeedetails/emp_satisfaction_survey">
				...
				foreach($record_data as $row){ ?>
                    ...
                    <tr>
                       ...
                       <td style="display: flex;">
                           	<?php if($role =='employee'){ ?>
                       <a href="<?php echo base_url(); ?>index.php/Employeedetails/edit_emp_satisfaction_survey/<?php echo $row->emp_satisfaction_survey_id ?>/view">
                           <i class="material-icons" data-toggle="tooltip" title="View">&#xe417;</i></a>
                            <?php }  else { ?>
                <a href="<?php echo base_url(); ?>index.php/Employeedetails/edit_emp_satisfaction_survey/<?php echo $row->emp_satisfaction_survey_id ?>/edit">
