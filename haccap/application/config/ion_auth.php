...
$config['tables']['groups']          = 'customer_groups';
$config['tables']['users_groups']    = 'customer_users_groups';
 ...
 */
$config['site_title']                 = "Cafe Admin";       // Site Title, example.com
$config['admin_email']                = "cafeadmin@cafeadmin.com.au"; // Admin Email, admin@example.com
