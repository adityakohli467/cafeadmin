<link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>assets/css/table_design.css">
				...
				<div style="margin-bottom:0px;float:none;" class="col-md-12 page-head">
	...
	<div class="container-fluid">
        <div class="table-wrapper">
			...
			<?php if(isset($row->doc_name)){ echo $row->doc_name; } ?>
                       ...
                       <a href="#" onClick="deletemodal(<?php echo $row->document_id ?>)"  ><i class="material-icons">Remove</i></a> 
...
$(document).ready(function(){
    ...
    $("#delete_document").on('click',function(){
		...
		$.ajax({
		    ...
		    url: "<?php echo base_url(); ?>index.php/haccp/delete_document",
		    data: {"id":data1},
