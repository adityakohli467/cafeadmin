...
<div class="container-fluid main-container emp-dashboard">
	<div class="row">
		...
		<td class="column100 column4 ct-status" data-column="column4"><span>
		    <?php if($row->roster_template == 1){ ?>
                                <a href="<?php echo base_url(); ?>index.php/admin/re_create_roster_beta/<?php echo $row->roster_group_id ?>">Re Create</a>
                               <?php }else{ ?>
                               <a href="<?php echo base_url(); ?>index.php/admin/re_create_roster/<?php echo $row->roster_group_id ?>">Re Create</a>
                               <?php } ?>
