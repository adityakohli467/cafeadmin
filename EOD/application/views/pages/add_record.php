									    ...
									    <div class="row">
                                                        ...
                                                        <tr class="menurow">
                                                            ...
                                                            <td class="menuinput-width">
                                                                 ...
                                                                 <?php if($row['supplier_name'] == ''){ ?>
                                                                   <input type="text"  <?php echo $disabled; ?> class="form-control"  value="<?php echo $row['input_supplier_name']; ?>" placeholder="Supplier Name">
                                                               <?php } else{ ?>
                                                                    <select  <?php echo $disabled; ?> class="form-control" name="supplier_name[]" data-rel="Supplier Name" id="supplier_name">
                                                                    <option value="">Select Supplier Name</option>
                                                                    
                                                                        <?php foreach($form_fields['suppliers'] as $row1){ 
                                                                            if( $row1['id'] == $row['supplier_name']){
                                                                        ?>
                                                            ...
                                                            <?php }else{ ?>
                                                             <td class="menuinput-width dropdownautocomplete">
                                                                <label>Supplier Name </label><span class="fieldChange rightfloat fieldChangeinput" onclick="fieldChangeinput(this)" <?php if($row['supplier_name'] == ''){ ?>style="display:none" <?php } ?>>Add supplier manually</span><span class="fieldChange rightfloat fieldChangeselect" onclick="fieldChangeselect(this)" <?php if($row['supplier_name'] == ''){ ?>style="display:block" <?php } ?>>Select manually</span>
                                                                <?php if($row['supplier_name'] == ''){ ?><style>.selectdropdown_<?php echo $i; ?>{display:none;}</style> <?php } ?>
                                                                <select  <?php echo $disabled; ?> class="form-control selectdropdown selectdropdown_<?php echo $i; ?>" name="supplier_name[]" data-rel="Supplier Name" id="supplier_name">
                                                                    <option value="">Select Supplier Name</option>
                                                                ...
                                                                <input type="text"  <?php echo $disabled; ?> class="form-control input_selectdropdown" name="input_supplier_name[]" value="<?php echo $row['input_supplier_name']; ?>" placeholder="supplier Name" <?php if($row['supplier_name'] == ''){ ?>style="display:block" <?php }else{ ?>style="display:none;" <?php } ?>>
                                                            </td>
                                                            <?php } ?>
                                                           <td class="menuinput-width">
                                                                 <label>Supplier Cost</label>
                                                                <input type="number"  <?php echo $disabled; ?> class="form-control" id="supplier_cost" name="supplier_cost[]" value="<?php echo $row['supplier_cost']; ?>" placeholder="Supplier Cost" >
                                                            </td>
									        ...
									        <div class="col-lg-5 ">
									            <table class="row-border table-condensed supplierCostTable" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <tr><td width="50%"><div class="customTableCell highlightedCell">Total Cash Bill</div></td><td width="30%"><div class="form-icon"><input class="form-control form-control-icon highlightedCell" type="number" <?php echo $disabled; ?> name="total_cost" id="totalCashBill" value="<?php echo $form_fields_data['record']['totalCashBill']; ?>" readonly><i class="bx bx-dollar text-white"></i></div></td><td></td></tr>
                                                        <?php if(!empty($form_fields_data['record']['bill'])){ $i=0;
                                                        foreach($form_fields_data['record']['bill'] as $row ){ ?>
                                                        <tr class="menurow">
                                                            <td class="menuinput-width" colspan="2"  width="80%">
                									            ...
                									            <?php if($field['field_type'] == 'dropdown_table'){ ?>
                									                    ...
                									                    <thead>
                									                        ...
                									                        <th style="width:50%">
                									                                <?php $field_name = $field['field_name']; ?>
                                                                                                <select  <?php echo $disabled; ?> class="form-control" name="<?php echo $field_name; ?>[]" required id="<?php echo $field_name; ?>" data-count="<?php echo $i; ?>" onchange="fetchData(this)">
                                                                                                <option value="">Select <?php echo str_replace("_"," ",$field_name) ?></option>
                                                                                                
                                                                                                <?php if($field['field_content'] != ''){ ?>
                                                                                                <?php $listData =$field['field_content']; ?>
                                                                                                    <?php foreach($form_fields[$listData] as $list){ 
                                                                                                        if($list['id'] == $row['main_category']){
                                                                                                    ?>
                									                        ...
                									                        <th style="width:50%">
                                                                                ...
                                                                                <select <?php echo $disabled; ?>  class="form-control" name="supplier_id[]" id="supplier_id" >
                                                                                    <option value="">Supplier</option>
                                                                                    <?php if($row['supplier_id'] != ''){
                                                                                    foreach($form_fields['suppliers'] as $row1){ 
                                                                                        if(in_array($row1['id'],$row['associated_supplier'])){
                                                                                        if($row1['id'] == $row['supplier_id']){
                                                                                    ?>
                                                                                    <option value="<?php echo $row1['id']; ?>" selected><?php echo $row1['name']; ?></option>
                                                                                    <?php }else{ ?>
                                                                                        <option value="<?php echo $row1['id']; ?>"><?php echo $row1['name']; ?></option>
                									                    ...
                									                    <tbody class="dataWrap">
                									                        <?php if(!empty($row['sub_category'])){ 
                									                            $total = 0;
                                                                                $price = 0;
                									                            foreach($row['sub_category'] as $tablerow){
                									                            ...
                									                            ?>
                									                            <tr><td><div class="customTableCell"><?php echo $tablerow['sub_category_name']; ?></div></td><td><input type="hidden" name="price_id_<?php echo $i; ?>[]" value="<?php echo $tablerow['supplier_sub_category_id']; ?>"><div class="form-icon"><input class="form-control form-control-icon category_cost" type="number" <?php echo $disabled; ?> name="price_<?php echo $i; ?>[]" onclick="addCost(this)" id="<?php echo $tablerow['supplier_sub_category_id']; ?>" value="<?php echo $price; ?>"><i class="bx bx-dollar"></i></div></td></tr>
                									                            <?php } ?>
                									                            <tr><td><div class="customTableCell highlightedCell">Total</div></td><td><div class="form-icon"><input class="form-control form-control-icon highlightedCell" type="number" <?php echo $disabled; ?> name="total_cost" id="totalCost" value="<?php echo $total; ?>" readonly><i class="bx bx-dollar text-white"></i></div></td></tr>
                									                        <?php } ?>
                									                    </tbody>
                									                </table>
                                                            ...
                                                            <td class="menuinput-width" colspan="2">
                									            ...
                									            <?php if($field['field_type'] == 'dropdown_table'){ ?>
                									                    ...
                									                    <thead>
                									                        ...
                									                        <th style="width:50%">
                									                                <?php $field_name = $field['field_name']; ?>
                                                                                                <select  <?php echo $disabled; ?> class="form-control" name="<?php echo $field_name; ?>[]" required id="<?php echo $field_name; ?>" data-count="0" onchange="fetchData(this)">
                                                                                                <option value="">Select <?php echo str_replace("_"," ",$field_name) ?></option>
...
$(document).on("click", ".add_field_button" , function() {
        ...
        $(this).closest('.menurow').next('.menurow').find('.dataWrap').html('');
...
function fetchData(obj){
    ...
    $.ajax({
	    ...
	    success: function(data){
            ...
            $(obj).closest('.menurow').find('#supplier_id').html(suppOptions);
            $(obj).closest('.menurow').find('#supplier_id').removeAttr('disabled');
		    ...
		    success: function(data){
                ...
                //  console.log(data);
                 ...
                 $.each(data1, function(i, value) {
                    ...
                    //     price = 0;
                    //  }
                     menuOptions+='<tr><td><div class="customTableCell">'+value.name+'</div></td><td><input type="hidden" name="price_id_'+datacount+'[]" value="'+value.id+'"><div class="form-icon"><input class="form-control form-control-icon category_cost" type="number" name="price_'+datacount+'[]" onclick="addCost(this)" id="'+value.id+'" value="0"><i class="bx bx-dollar"></i></div></td></tr>';
                     
                     
                });
                 menuOptions+='<tr><td><div class="customTableCell highlightedCell">Total</div></td><td><div class="form-icon"><input class="form-control form-control-icon highlightedCell" type="number" name="total_cost" id="totalCost" value="0" readonly><i class="bx bx-dollar text-white"></i></div></td></tr>';
                ...
                $(obj).closest('.menurow').find('.dataWrap').html(menuOptions);
		    }
		});
    }else{
        
         $(obj).closest('.menurow').find('.dataWrap').html('');
         $(obj).closest('.menurow').find('#supplier_id').html('');
    }
    var totalCashBill = 0;
     $('.category_cost').each(function() {
        ...
        $('#totalCashBill').val(totalCashBill);
}
...
function addCost(obj){
    ...
    $(obj).keyup(function(){
        ...
        var totalCashBill=0;
    console.log('loop2');
    var currentTable = $(obj).closest('.menurow').find('.category_cost');
    ...
    $('.category_cost').each(function() {
        ...
        $('#totalCashBill').val(totalCashBill);
        $(obj).closest('.menurow').find('#totalCost').val(sum);
   });
