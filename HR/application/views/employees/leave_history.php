...
<div style="background-color:#fff;" class="container-fluid main-container leave-history">
	<div class="col-md-12">
			...
			<table id="example" class="row-border table-condensed datatable" cellspacing="0" width="100%">
				...
				?>
					<tr class="tr">
						...
						<td class="text-left"><div <?php echo $color; ?> class="status-color" ><?php echo $btn_name;  ?></div>
						<?php if($row->comments != ''){ ?>
...
<script type="text/javascript">
	function delete_row(str){
		if(confirm('Are you sure you would like to delete the Leave')){
		    $.ajax({
				type: "POST",
...
$("#order_filters").on('submit',function(e){
	...
	window.location.href="<?php echo base_url(); ?>index.php/employees/manager_leave_filter/"+end_date+"/"+start_date+"/"+status;
