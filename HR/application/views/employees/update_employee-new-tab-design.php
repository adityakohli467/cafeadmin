...
ul.tabs li {
    ...
    font-family: poppins;
    font-size: 15px;
    border-bottom: 1px solid #314d70;
}
ul.tabs li.active {
  			...
  			<div class="col-lg-12">
  			    <div class="tabs_wrapper">
                        <ul class="tabs">
                          ...
                          <li rel="nextofKin">Next of Kin</li>
                          <li rel="generalInfo">General Info</li>
                          <li rel="postalAddress">Postal Address</li>
						...
						<div class="form-group">
                          ...
                          <!-- #tab1 -->
                          <h3 class="tab_drawer_heading" rel="nextofKin">Next of Kin</h3>
                          <div id="nextofKin" class="tab_content">
                          <h2>Next of Kin</h2>
                       ...
                       <div class="form-group">
						...
						<div class="form-group">
                          ...
                          <!-- #tab3 -->
                          <h3 class="tab_drawer_heading" rel="postalAddress">Postal Address</h3>
