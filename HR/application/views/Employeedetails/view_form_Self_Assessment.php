	          		...
	          		<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" readonly class="form-control" name="emp_name" value="<?php if(isset($details[0]->emp_name)){ echo $details[0]->emp_name; } ?>" autocomplete="off" required >
							</div>
						</div>
						<div class="form-group">
							<label for="businessname" class="col-lg-4 col-sm-12 control-label">Date Completed:<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
				<input type="text" readonly class="form-control datepicker"  name="completed_date"  value="<?php if(isset($details[0]->completed_date)){ echo $details[0]->completed_date; } ?>" autocomplete="off" required>
							</div>
						</div>
						<div class="form-group">
							<label for="abn" class="col-lg-4 col-sm-12 control-label">What could you Improve On?<span>*</span></label>
							<div class="col-lg-8 col-sm-12">
								<input type="text" readonly class="form-control" name="improve_on"  value="<?php if(isset($details[0]->improve_on)){ echo $details[0]->improve_on; } ?>"   autocomplete="off" required>
							</div>
						</div>
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" readonly class="form-control" name="steps"  value="<?php if(isset($details[0]->steps)){ echo $details[0]->steps; } ?>"   autocomplete="off" required>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
                               <input type="text" readonly class="form-control" name="goals" value="<?php if(isset($details[0]->goals)){ echo $details[0]->goals; } ?>" >
							</div>
						</div>
						<?php if(isset($details[0]->Employee_Self_Assessment_id)){ ?>
						<div class="form-group">
