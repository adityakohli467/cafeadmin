	...
	<span>
		...
		<input type="hidden" name="Employee_reimbursement_id" value="<?php if(isset($details[0]->Employee_reimbursement_id)){ echo $details[0]->Employee_reimbursement_id; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
				<input type="text" readonly class="form-control datepicker"  name="completed_date"  autocomplete="off" required value="<?php if(isset($details[0]->completed_date)){ echo $details[0]->completed_date; } ?>">
							</div>
						</div>
						<div class="form-group">
