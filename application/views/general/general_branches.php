      			...
      			<div class="modules-wrapper">
					...
					<?php foreach($branches_list as $branches){ ?>
					    <div class="col-lg-2 col-md-3 col-sm-4 col-xs-6">
					        <a href="<?php echo base_url(); ?>index.php/general/setBranch/<?php echo $branches->branch_id;?>/<?php echo str_replace(' ', '_',$branches->branch_name);?>">
					            <div class="modules">
    							 	<div class="modules-box">
    							 		<img class="modules-images" style="max-width:90px;width:100%;" src="<?php echo base_url(); ?>images/modules/shop2.png">
    							 	</div>
