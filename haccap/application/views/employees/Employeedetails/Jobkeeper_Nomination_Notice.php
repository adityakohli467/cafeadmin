        	...
        	<div class="col-md-6">
	        	<div class="panel pn">
				    ...
				    <input type="hidden" name="emp_id" value="<?php if(isset($details[0]->emp_id)){ echo $details[0]->emp_id; } ?>">
						...
						<input type="text" class="form-control" name="business_name" autocomplete="off" required value="<?php if(isset($details[0]->business_name)){ echo $details[0]->business_name; } ?>" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" class="form-control" name="business_abn" autocomplete="off" required value="<?php if(isset($details[0]->business_abn)){ echo $details[0]->business_abn; } ?>" >
							</div>
						</div>
					...
					<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" class="form-control" name="emp_full_name" autocomplete="off" required value="<?php if(isset($details[0]->emp_full_name)){ echo $details[0]->emp_full_name; } ?>" >
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
				<input type="text" class="form-control datepicker"  name="dob"  autocomplete="off" required value="<?php if(isset($details[0]->dob)){ echo $details[0]->dob; } ?>">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" class="form-control" name="phone_no"  autocomplete="off" required value="<?php if(isset($details[0]->phone_no)){ echo $details[0]->phone_no; } ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
                               <input type="text" class="form-control" name="contact_email" required value="<?php if(isset($details[0]->contact_email)){ echo $details[0]->contact_email; } ?>">
							</div>
						</div>
