...
List = (function () {
    var t = {
            ...
            //                     (v.handlers = { updated: [] }),
            //                     (v.valueNames = []),
            //                     (v.utils = { getByClass: s, extend: i, indexOf: a, events: o, toString: l, naturalSort: n, classes: u, getAttribute: c, toArray: f }),
            //                     v.utils.extend(v, e),
            ...
            //                     var m = f === g ? "active" : "";
            //                     a.number(g, d, v, f, h)
            //                         ? ((i = r.add({ page: g, dotted: !1 })[0]), m && n(i.elm).add(m), i.elm.firstChild.setAttribute("data-i", g), i.elm.firstChild.setAttribute("data-page", u))
