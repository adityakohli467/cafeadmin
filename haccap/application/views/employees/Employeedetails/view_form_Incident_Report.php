        	...
        	<div class="col-md-6">
	          		...
	          		<div class="panel-body">
						...
						<input type="hidden" name="emp_id" value="<?php if(isset($details[0]->emp_id)){ echo $details[0]->emp_id; } ?>">
							<input type="hidden" name= "Incident_Report_id" value="<?php if(isset($details[0]->Incident_Report_id)){ echo $details[0]->Incident_Report_id; } ?>">
								<input type="text" readonly class="form-control" name="work_area" autocomplete="off" value="<?php if(isset($details[0]->work_area)){ echo $details[0]->work_area; } ?>">
							</div>
						</div>
						<div class="form-group">
				...
				<input type="text" readonly class="form-control"  name="supervisor_on_duty"  autocomplete="off" required value="<?php if(isset($details[0]->supervisor_on_duty)){ echo $details[0]->supervisor_on_duty; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
								<input type="text" readonly class="form-control" name="person_reporting_incident"  autocomplete="off" required value="<?php if(isset($details[0]->person_reporting_incident)){ echo $details[0]->person_reporting_incident; } ?>">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
				         <input type="text" readonly class="form-control datepicker"  name="incident_date"  autocomplete="off" required  value="<?php if(isset($details[0]->incident_date)){ echo $details[0]->incident_date; } ?>">
							</div>
						</div>
							<div class="form-group ">
							...
							<div class="col-lg-8 col-sm-12  input-group date datetimepicker3">
								...
								<input type="text" readonly class="form-control" name="incident_time" style="z-index: 1 !important;" autocomplete="off" required value="<?php if(isset($details[0]->incident_time)){ echo $details[0]->incident_time; } ?>">
						...
						<div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
                               <textarea  readonly class="form-control" name="incident_detail" rows="8" cols="80" ><?php if(isset($details[0]->incident_detail)){ echo $details[0]->incident_detail; } ?></textarea>
							</div>
						</div>
							...
							<div class="col-lg-8 col-sm-12">
				           <input type="text" readonly class="form-control"  name="investigation_result"  autocomplete="off" value="<?php if(isset($details[0]->investigation_result)){ echo $details[0]->investigation_result; } ?>">
							</div>
						   </div>
						   ...
						   <div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
				           <input type="text" readonly class="form-control"  name="action_to_take"  autocomplete="off" value="<?php if(isset($details[0]->action_to_take)){ echo $details[0]->action_to_take; } ?>">
							</div>
						   </div>
						   ...
						   <div class="form-group">
							...
							<div class="col-lg-8 col-sm-12">
				           <input type="text" readonly class="form-control"  name="emp_represntative"  autocomplete="off" value="<?php if(isset($details[0]->emp_represntative)){ echo $details[0]->emp_represntative; } ?>">
							</div>
						   </div>
							...
							<div class="col-lg-8 col-sm-12">
				         <input type="text" readonly class="form-control datepicker"  name="er_date"  autocomplete="off" value="<?php if(isset($details[0]->er_date)){ echo $details[0]->er_date; } ?>">
							</div>
						</div>
