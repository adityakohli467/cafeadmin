...
<body background="<?php echo base_url(); ?>assets/login/tsc1.jpg"  data-spy="scroll" data-target=".row" data-offset="50" background-position="center;">
	...
	<div class="container">
			...
			<div class="row ht" id="myscrollspy">
				<h3><?php echo 'Reset your password';?></h3>
			   ...
			   <div class="col-md-4 col-sm-4 log">
			  	...
			  	<div class="panel">
					  ...
					  <?php } ?>
			  		  <form action="<?php echo base_url() ?>index.php/auth/forgot_password_hr" method="post" class="login_form" id="form_forgotpwd">
					    ...
					    <div class="form-actions auth-btn-div" style="display: flex;">
					        <a href="<?php echo base_url(); ?>index.php/auth/homepage" class="btn btn-default"  style="background: #65d065;margin-right: 10px;"tabindex="-1"><b></b>Go Back to Login</b></a>
